  ...
  return (
    <div className="bg-[#F8FAFF] rounded-3xl overflow-hidden border border-slate-200">
      <div className="flex flex-col md:flex-row">
        {/* Mockup */}
        <div
          className={`flex-1 flex items-center justify-center p-10 md:p-12 bg-gradient-to-br ${project.mockupGradient} min-h-64 md:min-h-[400px] relative`}
        >
          {/* Placeholder phone — always visible as fallback */}
